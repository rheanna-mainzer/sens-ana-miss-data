...
- cr_Figure2_v2.R - create Figure 2 in paper
...
- sens_params_bin.R - inform choice of sensitivity parameters for analysis of binary outcome
- an_LSAC_bin.R - conduct analysis for the binary outcome
- an_LSAC_cont_int - conduct extended analysis of continuous outcome reported in Supplementary Material
